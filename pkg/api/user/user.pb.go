...
//Basic response containing email of the user
type Email struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
var file_user_user_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0x2c, 0x0a, 0x08, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x73,
	...
	0x6c, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x2c, 0x5a, 0x2a, 0x67, 0x69,
...
var file_user_user_proto_goTypes = []interface{}{
	...
	(*AllUsers)(nil), // 1: user.AllUsers
	(*Email)(nil),    // 2: user.Email
	(*Empty)(nil),    // 3: user.Empty
}
var file_user_user_proto_depIdxs = []int32{
	0, // 0: user.AllUsers.users:type_name -> user.User
